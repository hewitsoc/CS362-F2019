...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        return mineCard(choice1, choice2, state, handPos, currentPlayer, i, j);
    ...
    case baron:
        return baronCard(choice1, choice2, state, handPos, currentPlayer, i, j);
    ...
    case minion:
        return minionCard(choice1, choice2, state, handPos, currentPlayer, i, j);
    ...
    case tribute:
        return tributeCard(choice1, choice2, state, handPos, currentPlayer, nextPlayer, i, j);

    case ambassador:
        return ambassadorCard(choice1, choice2, state, handPos, currentPlayer, i, j);
