...
** Assignment	:	4
** Due Date     :   11/17/2019
** Description	:	A random test for the playBaron function implemented
**				:	in dominion.c
*********************************************************************/
...
int main() {
    ...
    for (i = 0; i < RUN_COUNT; i++) {
        ...
        for (j = 0; j < MAX_TESTS; j++) {
		    ...
		    choice1 = (rand() % 100) - 51;                                      //randomize choice 1 for playBaron
            ...
            printf("\nBegin RandomTest of playBaron()\n");
            playBaron(choice1, currentPlayer, &test);                       //run test
