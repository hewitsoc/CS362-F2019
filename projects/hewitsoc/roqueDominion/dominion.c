...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        return playMine(choice1, choice2, currentPlayer, handPos, state);
    ...
    case baron:
        return playBaron(choice1, currentPlayer, state);
    ...
    case minion:
       return playMinion(choice1, choice2, currentPlayer, handPos, state);
    ...
    case tribute:
        return playTribute(tributeRevealedCards, currentPlayer, nextPlayer, state);

    case ambassador:
        return playAmbassador(choice1, choice2, currentPlayer, handPos, state);
...
int playMinion(int choice1, int choice2, int currentPlayer, int handPos, struct gameState *state)
{
    //+1 action
    state->numActions++;
...
int playMine(int choice1, int choice2, int currentPlayer, int handPos, struct gameState *state)
{
