...
** Assignment	:	4
** Due Date     :   11/17/2019
** Description	:	A random test for the playMinion function implemented
**				:	in dominion.c
*********************************************************************/
...
int main() {
    ...
    for (i = 0; i < RUN_COUNT; i++) {
        ...
        for (j = 0; j < MAX_TESTS; j++) {
            ...
            choice1 = (rand() % 100) - 51;                                      //randomize choice 1 for playMinion

            choice2 = (rand() % 100) - 51;                                      //randomize choice 2 for playMinion
            ...
            printf("\nBegin RandomTest of playMinion()\n");
            playMinion(choice1, choice2, currentPlayer, &test, handPos);                       //run test
            ...
            if (choice1) {
                printf("\nTest expected functionality of playMinion \nand player chooses +2 coins with choice of 1:\n"); 
                custom_assert(originalCoins + 2 == test.coins, &testSuccess, "");
            }   else if (choice2) {
                printf("\nTest expected functionality of playMinion if player chooses to redraw hand with choice 2\n");
